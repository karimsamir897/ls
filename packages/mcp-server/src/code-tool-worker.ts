...
const fuse = new Fuse(
  [
    'client.v1.share.heatmaps.retrieve',
    'client.v1.heatmap.create',
    'client.v1.heatmap.deleteAll',
    'client.v1.heatmap.list',
    'client.v1.heatmap.rerun',
    'client.v1.heatmap.retrieve',
    'client.v1.heatmap.retrievePlaces',
    'client.v1.heatmap.configs.create',
    'client.v1.heatmap.configs.delete',
    'client.v1.heatmap.configs.list',
    'client.v1.heatmap.configs.retrieve',
    'client.v1.heatmap.grids.create',
    'client.v1.heatmap.grids.delete',
    'client.v1.heatmap.grids.list',
    'client.v1.heatmap.grids.retrieve',
    'client.v1.heatmap.keyword.lists.create',
    'client.v1.heatmap.keyword.lists.delete',
    'client.v1.heatmap.keyword.lists.deleteAll',
    'client.v1.heatmap.keyword.lists.list',
    'client.v1.heatmap.keyword.lists.retrieve',
    'client.v1.heatmap.keyword.lists.update',
    'client.v1.heatmap.schedules.create',
    'client.v1.heatmap.schedules.delete',
    'client.v1.heatmap.schedules.deleteBulkDelete',
    'client.v1.heatmap.schedules.list',
    'client.v1.heatmap.schedules.pause',
    'client.v1.heatmap.schedules.resume',
    'client.v1.heatmap.schedules.retrieve',
    'client.v1.heatmap.schedules.update',
    'client.v1.heatmap.competitors.list',
    'client.v1.heatmap.competitors.retrieveRankings',
  ],
